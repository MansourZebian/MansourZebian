...
<aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-[#ffffff] dark:bg-gray-800">
    ...
    <div className='mt-2  '> 
    <div className=' text-gray-500 text-left  '>Account #{user.id}</div>
    ...
    <div className=' text-black  font-bold float-start  '>{user && user.username && user.username.length > 10 ? `${user.username.slice(0, 10)}..` : user.username}
         ...
         <li >
            <a href="/chatting" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li >
            <a href="/info" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">

...
function Checkcards({title,checked,checktitle,transparent}) {
  return (
    <div className={ transparent ? 'rounded-3xl  w-full bg-transparent border border-[#7a92fb] items-center p-4 mb-3' : 'rounded-3xl  w-full bg-[#7a92fb]   items-center p-4 mb-3'}>
